...
/** Which tag to inject */
declare type InjectTag = 'script' | 'link' | 'style';
/**
...
export declare type ExternalScript = ISrcScript | ITextScript;
/** Injected link */
...
export declare type Entry = IScript | ILink;
...
export declare type External = ExternalScript | IExternalLink | IStyle;
